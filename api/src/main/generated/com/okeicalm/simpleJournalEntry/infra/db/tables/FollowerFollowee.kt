...
import com.okeicalm.simpleJournalEntry.infra.db.keys.KEY_FOLLOWER_FOLLOWEE_UNIQUE_INDEX
...
open class FollowerFollowee(
    ...
    override fun getUniqueKeys(): List<UniqueKey<FollowerFolloweeRecord>> = listOf(KEY_FOLLOWER_FOLLOWEE_UNIQUE_INDEX)
